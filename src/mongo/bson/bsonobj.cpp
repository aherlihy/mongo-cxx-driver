...
namespace mongo {
    ...
    BSONObj BSONObj::copy() const {
        char* storage = static_cast<char*>(malloc(sizeof(Holder) + objsize()));
    ...
    void _getFieldsDotted( const BSONObj* obj, StringData, BSONElementColl &ret, bool expandLastArray ) {
    ...
    void BSONObj::getFieldsDotted(StringData, BSONElementSet &ret, bool expandLastArray ) const {
        _getFieldsDotted( this, name, ret, expandLastArray );
    }
    void BSONObj::getFieldsDotted(StringData, BSONElementMSet &ret, bool expandLastArray ) const {
        _getFieldsDotted( this, name, ret, expandLastArray );
    }
    ...
    BSONElement BSONObj::getFieldUsingIndexNames(StringData,
    ...
    */
    ...
    BSONElement BSONObj::getField(StringData) const {
        BSONObjIterator i(*this);
        while ( i.more() ) {
            BSONElement e = i.next();
            if ( name == e.fieldName() )
    ...
    int BSONObj::getIntField(StringData) const {
        BSONElement e = getField(name);
        return e.isNumber() ? (int) e.number() : std::numeric_limits< int >::min();
    }

    bool BSONObj::getBoolField(StringData) const {
        BSONElement e = getField(name);
        return e.type() == Bool ? e.boolean() : false;
    }

    const char * BSONObj::getStringField(StringData) const {
        BSONElement e = getField(name);
    ...
    BSONObj BSONObj::removeField(StringData) const {
        BSONObjBuilder b;
        BSONObjIterator i(*this);
        while ( i.more() ) {
            BSONElement e = i.next();
    ...
    */
    BSONElement BSONObj::getFieldDotted(StringData) const {
        BSONElement e = getField(name);
        if (e.eoo()) {
    ...
    BSONObj BSONObj::getObjectField(StringData) const {
        BSONElement e = getField(name);
        BSONType t = e.type();
