...
namespace mongo {
    ...
    Status::ErrorInfo::ErrorInfo(ErrorCodes::Error aCode, StringData, int aLocation)
        : code(aCode), reason(aReason.toString()), location(aLocation) {
    }

    Status::ErrorInfo* Status::ErrorInfo::create(ErrorCodes::Error c, StringData, int l) {
